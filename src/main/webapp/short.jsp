...
<body>
    <div id="outline">
        <h3>APPLYING FOR SHORT-TERM LEAVE</h3>
        <form allign="center">
            <label for="leavetype">LEAVETYPE:</label><select name="leavetype">
                <option value="CASUAL">CASUAL LEAVE APPLICATION</option>
                <option value="MARRIAGE">Paternal LEAVE APPLICATION</option>
                <option value="SICK">SICK LEAVE APPLICATION</option>
            </select><br><br>
            <label for="duration">DURATION:</label><input type="number" name="duration" min="1" max="3" value="1"><br><br>
