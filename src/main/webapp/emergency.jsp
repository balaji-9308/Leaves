...
<body>
    <div id="outline">
        <h3>APPLYING FOR EMERGENCY LEAVE</h3>
        <form align="center">
            <label for="leavetype">LEAVETYPE:</label><select name="leavetype">
                <option value="CASUAL">BEREAVEMENT LEAVE</option>
                <option value="MARRIAGE">SICK LEAVE</option>
                <option value="SICK">PATERNITY LEAVE</option>
            </select><br><br>
            <label for="duration">DURATION:</label><input type="number" name="duration" min="1" max="7" value="1"><br><br>
